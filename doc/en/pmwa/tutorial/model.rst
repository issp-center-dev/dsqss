...
There are two kinds of parameters in the input file: parameters specifying calculation conditions and parameters specifying a Hamiltonian.
...
- Parameter of calculation conditions
  ...
  .. csv-table::
     ...
     NVERMAX, int, "The maximum number of vertexes (default is :math:`10^8` ). There is no upper limit when -1."
     NWORMAX, int, "The maximum number of worms (default is :math:`10^3` ). There is no upper limit when -1."
...
PMWA can treat the models for hard-core boson and :math:`S=1/2` XXZ system. 
...
For :math:`S=1/2` XXZ model, the hamiltonian is given by
